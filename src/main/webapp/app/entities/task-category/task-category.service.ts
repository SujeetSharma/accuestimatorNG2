...
export class TaskCategoryService {
    ...
    private resourceUrl: string =  'api/task-categories';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(taskCategory: TaskCategory): Observable<TaskCategory> {
        let copy: TaskCategory = Object.assign({}, taskCategory);
        copy.createdon = this.dateUtils.toDate(taskCategory.createdon);
        copy.modifiedon = this.dateUtils.toDate(taskCategory.modifiedon);
    ...
    find(id: number): Observable<TaskCategory> {
