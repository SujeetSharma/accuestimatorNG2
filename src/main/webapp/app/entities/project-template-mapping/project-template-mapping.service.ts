...
@Injectable()
export class ProjectTemplateMappingService {

    private resourceUrl: string =  'api/project-template-mappings';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(projectTemplateMapping: ProjectTemplateMapping): Observable<ProjectTemplateMapping> {
        let copy: ProjectTemplateMapping = Object.assign({}, projectTemplateMapping);
        copy.createdon = this.dateUtils.toDate(projectTemplateMapping.createdon);
        copy.modifiedon = this.dateUtils.toDate(projectTemplateMapping.modifiedon);
        return this.http.post(this.resourceUrl, copy).map((res: Response) => {
            return res.json();
        });
    }

    update(projectTemplateMapping: ProjectTemplateMapping): Observable<ProjectTemplateMapping> {
        let copy: ProjectTemplateMapping = Object.assign({}, projectTemplateMapping);
    ...
    find(id: number): Observable<ProjectTemplateMapping> {
