...
export class ProjectUserMappingService {
    ...
    private resourceUrl: string =  'api/project-user-mappings';

    constructor(private http: Http, private dateUtils: DateUtils) { }

    create(projectUserMapping: ProjectUserMapping): Observable<ProjectUserMapping> {
        let copy: ProjectUserMapping = Object.assign({}, projectUserMapping);
        copy.createdon = this.dateUtils.toDate(projectUserMapping.createdon);
        copy.modifiedon = this.dateUtils.toDate(projectUserMapping.modifiedon);
        return this.http.post(this.resourceUrl, copy).map((res: Response) => {
            return res.json();
        });
    }

    update(projectUserMapping: ProjectUserMapping): Observable<ProjectUserMapping> {
        let copy: ProjectUserMapping = Object.assign({}, projectUserMapping);
    ...
    find(id: number): Observable<ProjectUserMapping> {
